...
class MaskToEllipseConverter:
    ...
    def _preprocess_contour(self, contour: npt.NDArray) -> npt.NDArray | None:
    ...
    def process_folder(
        self, folder_path: str, background_label: int = 1, save_results: bool = True, output_folder: str | None = None
