...
from PySide6.QtWidgets import QApplication, QLabel, QMainWindow, QVBoxLayout, QWidget, QDialog
...
class ImageLabel(QLabel):
    ...
    def set_image(self, img: npt.NDArray[np.uint8]):
        self.img = img
    ...
    def update_image(self):
        ...
        bytes_per_line = 3 * width
        q_img = QImage(self.img_copy.data, width, height, bytes_per_line, QImage.Format_RGB888)
        self.setPixmap(QPixmap.fromImage(q_img))
