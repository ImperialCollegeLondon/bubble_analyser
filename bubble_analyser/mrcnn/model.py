...
def build_fpn_mask_graph(rois, feature_maps, image_meta, pool_size, num_classes, num_deconv_layers, train_bn=True):
...
class MaskRCNN:
    ...
    def compile(self, learning_rate, beta_1, beta_2):
        ...
        optimizer = keras.optimizers.Adam(
            lr=learning_rate, beta_1=beta_1, beta_2=beta_2, clipnorm=self.config.GRADIENT_CLIP_NORM
        )
        # Add Losses
